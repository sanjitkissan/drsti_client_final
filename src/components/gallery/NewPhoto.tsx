...
export default function NewPhoto() {
  ...
  useEffect(() => {
    const fetchStaticData = async () => {
        try {
            const response = await fetch('http://localhost:1337/api/statics');
...
useEffect(() => {
    const fetchActivationData = async () => {
        try {
            const response = await fetch('http://localhost:1337/api/activations/');
            const jsonData = await response.json();
            // console.log(jsonData.data)
            // const preData=jsonData.data
            // const newData=[]
...
useEffect(() => {
    const fetchDigitalData = async () => {
        try {
            const response = await fetch('http://localhost:1337/api/digitals/');
            const jsonData = await response.json();
            // console.log(jsonData.data)
            // const preData=jsonData.data
            // const newData=[]
